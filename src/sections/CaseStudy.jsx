                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <div className="space-y-6 text-textSecondary text-lg leading-relaxed">
                            ...
                            <p>
                                When I stopped chasing "likes" and started building **systems**, the work didn't just get better—it got automated. No revisions. No "circling back." Just profit on a dashboard.
                            </p>
                            <p>
